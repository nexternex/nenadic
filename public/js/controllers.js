...
//KONTROLER: List controller
    myDay.controller('ListController', ['$scope','$rootScope', '$http','$mdDialog','auth', '$location','$filter','$timeout', function ($scope,$rootScope,$http,$mdDialog,auth, $location,$filter,$timeout) {
        ...
        $http.jsonp('https://docs.google.com/spreadsheets/d/e/2PACX-1vRb_J-jIVbkU-6S4Ou4gyXRv3muwVA2Yt7M4Ik_KJSs-t-E3UHIw0PGE1qXxhNr1k1nwgO2NyMwULAp/od6/public/values?alt=json-in-script&callback=JSON_CALLBACK')
            .success(function(data) {
