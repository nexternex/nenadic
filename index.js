...
var schema_user = new mongoose.Schema({ name: 'string',lastname:'string',address:'string',email:'string',phone:'string',type:'string',date:"string",u_id:'string',registered:'string',ido:'string'});
...
//BACKEND ROUTES API/////////////////////////////////////////////////////////////////////////////
	...
	app.post('/api/user_ido:user_id', function(req, res) {
		User.update({ 'u_id': req.params.user_id },{ $push: { ido :req.body.id_c}}, function(err, user) {
			if (err)
				res.send(err);
			// get and return all the lists after you create another
		});
